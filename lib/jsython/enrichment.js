(function (factory) {
    ...
    var baseexcproto;
    var None, NoneType, NotImplemented, NotImplementedType;
    var nonetypeproto, notimpltypeproto;
    ...
    IndexError = _exceptions.IndexError;
    KeyError = _exceptions.KeyError;
    LookupError = _exceptions.LookupError;
    None = _auxobjects.None;
    NotImplemented = _auxobjects.NotImplemented;
    NoneType = None.__class__;
    NotImplementedType = NotImplemented.__class__;
    ...
    // type class enrichment
    type.__name__ = str_cons('type');
    ...
    listproto.__getitem__ = function (key) {
        var i;
        if (!(key instanceof int)) {
            throw TypeError(str_cons(
                'list indices must be integers, not ' + js_type_name(key)));
        }
        i = key.__number__;
        if (i < 0 || i >= this.__array__.length) {
            throw IndexError(str_cons('list index out of range'));
        }
        return this.__array__[i];
    };

    listproto.__setitem__ = function (key, value) {
        var i;
        if (!(key instanceof int)) {
            throw TypeError(str_cons(
                'list indices must be integers, not ' + js_type_name(key)));
        ...
        this.__array__[i] = value;
        return None;
    };

    listproto.__delitem__ = function (key) {
        var i;
        if (!(key instanceof int)) {
            throw TypeError(str_cons(
                'list indices must be integers, not ' + js_type_name(key)));
    ...
    // aux objects enrichment
    NoneType.__name__ = str_cons('NoneType');

    nonetypeproto = NoneType.prototype;

    nonetypeproto.__repr__ = function () {
        return str_cons('None');
    };

    NotImplementedType.__name__ = str_cons('NotImplementedType');

    notimpltypeproto = NotImplementedType.prototype;

    notimpltypeproto.__repr__ = function () {
        return str_cons('NotImplemented');
    };
    ...
    KeyError.__name__ = str_cons('KeyError');

    IndexError.__name__ = str_cons('IndexError');

    LookupError.__name__ = str_cons('LookupError');
